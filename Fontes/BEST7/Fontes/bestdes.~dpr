...
uses
  ...
  UfrmViewED in 'UfrmViewED.pas' {frmViewED},
  std_prel in 'std_prel.pas' {frm_pvertstd},
  bst_pativ in 'bst_pativ.pas' {frm_pativ},
  bst_pativ1 in 'bst_pativ1.pas' {frm_pativ1},
  UProcEFunc in 'uprocefunc.pas',
  UfrmRelAtiv in 'UfrmRelAtiv.pas' {frmRelAtiv},
  UqrpAtividade_1 in 'UqrpAtividade_1.pas' {qrpAtividade_1: TQuickRep},
  bst_pac in 'bst_pac.pas' {frm_pac},
  BST_pdmig in 'BST_pdmig.pas' {frm_pdmig},
  BST_pentext in 'BST_pentext.pas' {frm_pEntext};
...
begin
 { SetLastError(NO_ERROR);
  ...
  Application.CreateForm(Tfrm_pEntext, frm_pEntext);
  Application.Run;
end.
