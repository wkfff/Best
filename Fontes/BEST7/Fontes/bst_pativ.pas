...
uses
  ...
  std_prel, QuickRpt, Qrctrls, ExtCtrls,  jpeg, AddFlow3Lib_TLB, 
  fonctions, bstdb, cls_obj, QRExport, QRWebFilt, QRXMLSFilt, QRPDFFilt;
...
type
  Tfrm_pativ = class(Tfrm_pvertstd)
    ...
    qrdbtext2: TQRDBRichText;
    qrdbtext12: TQRDBRichText;
