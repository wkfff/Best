...
// (DO NOT EDIT: machine generated header) 'LbxCipher.pas' rev: 6.00
...
extern PACKAGE void __fastcall InitEncryptLBC(const Byte * Key, TLBCContext &Context, int Rounds, bool Encrypt);
...
extern PACKAGE void __fastcall EncryptTripleDESCBC(const TDESContext * Context, const Byte * Prev, Byte * Block);
extern PACKAGE void __fastcall InitEncryptTripleDES3Key(const Byte * Key1, const Byte * Key2, const Byte * Key3, TDESContext * Context, bool Encrypt);
extern PACKAGE void __fastcall EncryptTripleDES3Key(const TDESContext * Context, Byte * Block);
extern PACKAGE void __fastcall EncryptTripleDESCBC3Key(const TDESContext * Context, const Byte * Prev, Byte * Block);
...
extern PACKAGE void __fastcall EncryptBFCBC(const TBFContext &Context, const int * Prev, int * Block, bool Encrypt);
