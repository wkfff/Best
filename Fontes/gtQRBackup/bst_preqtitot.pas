...
uses
  ...
  dbTables,db,math, gtQrCtrls, gtQRXport_WMF, gtQRXport_Metafile,
  gtQRXport_EMF, gtQRXport_BMP, gtQRXport_JPEG, gtQRXport_Graphic,
  gtQRXport_GIF, gtQRXport_Text, gtQRXport_Excel, gtQRXport_RTF,
  gtQRXport_XHTML, gtQRXport_HTML, gtQRXport, gtQRXport_Doc, gtQRXport_PDF,
  gtQRXport_Hub;
...
type
  Tfrm_preqtitot = class(Tfrm_pvertstd)
    ...
    QRLabel6: TgtQRLabel;
    QRLabel7: TgtQRLabel;
    pObjuc: TgtQRRichText;
    Regra: TgtQRRichText;
    pap: TgtQRRichText;
    ppg: TgtQRRichText;
    qrdesc: TgtQRRichText;
