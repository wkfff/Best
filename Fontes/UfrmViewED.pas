...
procedure TfrmViewED.ToolButton1Click(Sender: TObject);
begin
  ADOQuery1.DataSource.DataSet.Insert;
end;

procedure TfrmViewED.ToolButton2Click(Sender: TObject);
begin
ADOQuery1.DataSource.DataSet.Post;
end;

procedure TfrmViewED.ToolButton3Click(Sender: TObject);
begin
  frmViewED.Close;
end;

procedure TfrmViewED.dtp_dataCloseUp(Sender: TObject);
begin
  DataSource1.dataset.edit;
  db_data.field.text := formatdatetime('dd/mm/yyyy',dtp_data.date);
end;

procedure TfrmViewED.docextClick(Sender: TObject);
begin
