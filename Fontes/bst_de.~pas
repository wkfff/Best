...
uses
  Windows, bst_basefrm,Messages, SysUtils, Variants, Classes, Graphics, 
  Controls, Forms, Dialogs, BST_TELAOBJ, Mask, DBCtrls, StdCtrls, Grids, 
  DBGrids, ComCtrls, ImgList, Buttons, ToolWin, ExtCtrls, Menus, db, bstdb, 
  QuickRpt, Qrctrls, CLS_UTILS, ActnList;
