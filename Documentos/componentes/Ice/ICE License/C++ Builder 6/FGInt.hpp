...
// (DO NOT EDIT: machine generated header) 'FGInt.pas' rev: 6.00
...
extern PACKAGE void __fastcall FGIntDivByInt(const TFGInt &FGInt, TFGInt &res, unsigned by, unsigned &modres);
...
extern PACKAGE void __fastcall FGIntModBis(const TFGInt &FGInt, TFGInt &FGIntOut, unsigned b, unsigned head);
extern PACKAGE void __fastcall FGIntMulModBis(const TFGInt &FGInt1, const TFGInt &FGInt2, TFGInt &Prod, unsigned b, unsigned head);
extern PACKAGE void __fastcall FGIntMontgomeryMod(const TFGInt &GInt, const TFGInt &base, const TFGInt &baseInv, TFGInt &MGInt, unsigned b, unsigned head);
extern PACKAGE void __fastcall FGIntMontgomeryModExp(TFGInt &FGInt, TFGInt &exp, TFGInt &modb, TFGInt &res);
...
extern PACKAGE void __fastcall FGIntBezoutBachet(TFGInt &FGInt1, TFGInt &FGInt2, TFGInt &a, TFGInt &b);
...
extern PACKAGE void __fastcall FGIntSquareRootModP(const TFGInt &Square, const TFGInt &Prime, TFGInt &SquareRoot);
