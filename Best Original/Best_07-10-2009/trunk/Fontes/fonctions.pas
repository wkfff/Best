...
uses Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs,dbgrids,pList_std,strUtils,shellApi,QRCtrls, QuickRpt,ComCtrls, gtQrCtrls,
...
var
 ...
 If (pList is TgtQrmemo) then
   begin
    wCount :=  (pList as TgtQrmemo).Lines.Count;
     for i := 0 to wCount - 1 do
      begin
        If pValor = (pList as TgtQrmemo).Lines[i] then
         begin
           result := true  ;
           break;
         end;
