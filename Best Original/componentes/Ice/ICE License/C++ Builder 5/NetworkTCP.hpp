...
// (DO NOT EDIT: machine generated header) 'NetworkTCP.pas' rev: 5.00
...
typedef void __fastcall (__closure *TSimpleTCPAcceptEvent)(System::TObject* Sender, TSimpleTCPClient* 
	Client, bool &Accept);

typedef void __fastcall (__closure *TSimpleTCPServerEvent)(System::TObject* Sender, TSimpleTCPClient* 
	Client);

typedef void __fastcall (__closure *TSimpleTCPServerDataAvailEvent)(System::TObject* Sender, TSimpleTCPClient* 
	Client, int DataSize);

typedef void __fastcall (__closure *TSimpleTCPClientDataAvailEvent)(System::TObject* Sender, int DataSize
	);

typedef void __fastcall (__closure *TSimpleTCPServerIOEvent)(System::TObject* Sender, TSimpleTCPClient* 
	Client, Classes::TStream* Stream);

typedef void __fastcall (__closure *TSimpleTCPClientIOEvent)(System::TObject* Sender, Classes::TStream* 
	Stream);

typedef void __fastcall (__closure *TSimpleTCPErrorEvent)(System::TObject* Sender, int Socket, int ErrorCode
...
private:
	...
	int __fastcall ReceiveStreamFrom(TCustomSocket1* CSocket, Classes::TStream* Stream, int DataSize, bool 
		ReceiveCompletely);
...
public:
	...
	__property bool AllowChangeHostAndPortOnConnection = {read=FAllowChangeHostAndPortOnConnection, write=
		FAllowChangeHostAndPortOnConnection, default=0};
...
public:
	...
	int __fastcall ReceiveStream(TSimpleTCPClient* Client, Classes::TStream* Stream, int DataSize, bool 
		ReceiveCompletely);
...
__published:
	...
	__property TSimpleTCPServerDataAvailEvent OnClientDataAvailable = {read=FOnClientDataAvailable, write=
		FOnClientDataAvailable};
