...
// (DO NOT EDIT: machine generated header) 'IceLicense.pas' rev: 6.00
...
typedef void __fastcall (__closure *LicenseInfoEvent)(TLS LicenseType, AnsiString DateCreation, AnsiString UserName, AnsiString UserOrg, AnsiString VendorName, AnsiString VendorOrg, AnsiString ExpirationMode, AnsiString ExpirationInfo, bool NetworkControl, bool HardwareLocked);
...
protected:
	...
	void __fastcall WriteRL(AnsiString Username, AnsiString UserOrg, AnsiString LicenseK, AnsiString ActiveK, AnsiString DActivation);
	bool __fastcall ResetRL(void);
	bool __fastcall TLicenseRL(void);
	bool __fastcall ReadTrialRL(AnsiString LicenseDateCreation);
	void __fastcall WriteTrialRL(AnsiString LicenseDateCreation, AnsiString DateActivation, AnsiString LastDate, AnsiString TrialStatus);
...
public:
	...
	void __fastcall ClientErrorMsg(System::TObject* Sender, int Socket, int ErrorCode, const AnsiString ErrorMsg);
