...
// (DO NOT EDIT: machine generated header) 'LbxClass.pas' rev: 6.00
...
public:
	...
	/* TComponent.Create */ inline __fastcall virtual TLBBaseComponent(Classes::TComponent* AOwner) : Lbxcipher::TLBBase(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
